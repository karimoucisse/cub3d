...
CFILESBONUS = $(BONUS)main.c\
	...
	$(BONUS)init_structure.c $(BONUS)parsing.c $(BONUS)map_parsing.c $(BONUS)colors_fonctions.c\
	$(BONUS)textures_fonctions.c $(BONUS)key_action.c $(BONUS)map_parsing2.c $(BONUS)handle_end.c $(BONUS)init_structure2.c\
	$(BONUS)put_pixels.c $(BONUS)minimap.c $(BONUS)door_move.c
